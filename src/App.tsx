...
export default function App() {
  ...
  return (
    <div className="min-h-screen text-zinc-900 dark:text-white selection:bg-primary selection:text-black font-sans overflow-x-hidden cursor-default relative bg-slate-50 dark:bg-black transition-colors duration-500">
      <SecurityShield />
      
      {/* 3D Depth Wilderness Parallax Background */}
      <ParallaxHero className="fixed inset-0 z-0 opacity-40 dark:opacity-60 select-none pointer-events-none" />
      
      {/* Background Effect - Always Visible */}
      <div className="fixed inset-0 z-0 bg-white/20 dark:bg-black/40 pointer-events-none overflow-hidden touch-none">
      ...
      <style>{`
        ...
        .cinema-text-shadow { text-shadow: 0 0 35px rgba(255, 255, 255, 0.6), 0 0 60px rgba(255, 255, 255, 0.2); }
      `}</style>
    </div>
  );
}
